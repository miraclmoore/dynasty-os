          ...
          <div className="flex flex-col gap-4">
            {entries.length === 0 ? (
              <div className="bg-gray-800 rounded-lg p-8 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-sm font-medium text-gray-400 mb-1">No NIL deals logged yet</p>
                <p className="text-xs text-gray-600 max-w-xs">
                  Track brand deals by player, amount, and year. Spend breakdowns by position and
                  year will appear here once you log your first deal.
                </p>
              </div>
            ) : (
              <>
