          ...
          <div className="flex flex-col gap-6">
            ...
            {!activeSeason && !displayClass && (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h2 className="text-gray-300 font-semibold text-lg mb-2">No Active Season</h2>
                <p className="text-gray-500 text-sm max-w-sm mb-6">
                  Recruiting classes are tied to a season. Start your first season from the
                  dashboard, then come back here to log your class.
                </p>
                <button
                  onClick={goToDashboard}
                  className="px-5 py-2.5 bg-gray-700 hover:bg-gray-600 text-white text-sm font-semibold rounded-lg transition-colors"
          ...
          <div className="flex flex-col gap-4">
            ...
            {classes.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <h2 className="text-gray-300 font-semibold text-lg mb-2">No Recruiting Classes Yet</h2>
                <p className="text-gray-500 text-sm max-w-sm mb-6">
                  Track your recruiting class rank, star ratings, and individual commits. Switch to
                  "Current Class" to create your first class.
                </p>
                <button
                  onClick={() => setViewMode('entry')}
                  className="px-5 py-2.5 bg-amber-600 hover:bg-amber-500 text-white text-sm font-semibold rounded-lg transition-colors"
                >
                  Start Your Recruiting Class →
                </button>
              </div>
            ) : (
