...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'After every game, hit "+ Log Game" to record the result. Your record, stats, and rankings update automatically.',
    tip: null,
  ...
  },
  {
    ...
    body: 'When the season is over, hit "End Season" to lock in your final record, ranking, and bowl/playoff result. It resets the tracker for next year.',
    tip: 'The Season Checklist on the dashboard shows every step to complete before closing the year.',
    targetId: 'tour-end-season',
    page: 'dashboard',
  },
  {
    title: 'Program History',
    body: 'Track your legacy over time. Trophy Room shows every championship. Coaching Resume is your career record. Scouting Cards are printable opponent breakdowns.',
    tip: null,
    targetId: 'tour-program',
    page: 'dashboard',
  },
  {
    title: 'Your Roster',
    body: 'Manage Roster shows your current players and their stats. Program Legends is your all-time hall of fame. Records & Leaderboards tracks every single-season and career record.',
    tip: null,
    targetId: 'tour-roster',
    page: 'dashboard',
  },
  {
    title: 'Sport-Specific Tools',
    body: 'These tools are tailored to your game. CFB coaches get Recruiting, Transfer Portal, NFL Draft Tracker, Prestige, Rivalry Tracker, and more. NFL coaches get Franchise Sync and Community Rosters.',
    tip: null,
    targetId: 'tour-sport-section',
    page: 'dashboard',
  },
  {
    title: 'Your Live Dashboard',
    body: 'Once you start logging games, the main area fills in automatically — live record, recent results, weekly opponent, stat highlights, season checklist, and full game log. Everything in one place.',
    tip: null,
    targetId: null,
    page: 'dashboard',
  },
  {
    ...
    body: 'Hit "+ Log Game" after your first game to get started. Use Cmd+K to jump anywhere fast, or tap the ? button any time to replay this tour.',
    tip: null,
    targetId: null,
    page: 'dashboard',
  },
